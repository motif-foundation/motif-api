...
import (
	"motif-api/internal/repository/cache"
...
// Erc721ContractList returns a list of known ERC721 tokens ordered by their activity.
func (p *proxy) Erc721ContractList(count int32) ([]common.Address, error) {
	return p.db.Erc721ContractList(count)
}
