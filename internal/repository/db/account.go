...
// Erc721ContractList returns a list of known ERC20 tokens ordered by their activity.
func (db *MongoDbBridge) Erc721ContractList(count int32) ([]common.Address, error) {
	// make sure the count is positive; use default size if not
	if count <= 0 {
		count = defaultTokenListLength
	}
